...
% Phase-2 RX-LO model.  This is distinct from the per-user TX-side Wiener
% phase noise above.  The LO process owns a derived RandStream so enabling
% it cannot perturb signal/channel/noise/switch realizations.
sim.rxLo = struct('mode',"off",'phaseRmsDeg',0,'bandwidthHz',100e3, ...
...
sim.switch = struct('isolationDb', Inf, 'settlingRiseNs', 0, ...
    ...
    'settlingSlowDriftFraction', 0, 'settlingSlowDriftHz', 0, ...
